...
// Assignments
router.get('/admin/telecaller-owner/:id', requireRole('SUPER_ADMIN'), webController.getTelecallerAssignments);
router.post('/admin/set-telecaller-owner', requireRole('SUPER_ADMIN'), webController.setTelecallerOwner);
